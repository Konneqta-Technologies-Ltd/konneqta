...
export const metadata: Metadata = {
  ...
  // Root canonical — inherited by all pages that don't override it. Prevents
  // the "Duplicate without user-selected canonical" Search Console warning by
  // telling Google the authoritative URL for "/" is https://www.konneqta.com/.
