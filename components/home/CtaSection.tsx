...
export default function CtaSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#0a0a0a] px-6 pb-16 sm:pb-28 pt-20 sm:pt-40 md:pt-28">
      <div
      ...
      >
        ...
        <WavyLine
          color="#2DD9A6"
          className="absolute sm:right-[-10px] bottom-[10px] hidden sm:block"
          delay={0.3}
          flip
        />
        <FloatingDot
          color="#F3C23A"
          size={10}
          className="left-[60px] sm:left-[190px] top-[60px] sm:block"
        />
        <FloatingDot
          color="#2DD9A6"
          size={10}
          className="right-[60px] sm:right-[220px] top-[60px] sm:block"
          duration={4}
        />
      </div>
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="visible-focus mt-9 flex items-center gap-3 rounded-full bg-[#F3EFE4] text-sm sm:text-lg px-4 py-2 sm:px-7 sm:py-4 font-semibold text-[#0a0a0a] shadow-lg shadow-black/20 cursor-pointer"
